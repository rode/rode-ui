...
export const mockMappedResource = [
  {
    name: "",
    uri:
...
export const mockMappedOccurrences = {
  build: [
    {
      ...
      originals: [
        {
          name:
            "projects/rode/occurrences/999f4e01-fb04-4d1a-9ee5-df1ac7cf19b2",
          resource: {
            name: "",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
            ...
            provenance: {
              ...
              sourceProvenance: {
                artifactStorageSourceUri:
                  "input binary artifacts from this build",
                fileHashes: {},
                context: {
                  git: {
    ...
    },
    {
      ...
      started: "2020-03-14T12:08:39.728983Z",
      completed: "2020-03-14T12:09:39.728983Z",
      creator: "user initiating the build",
      artifacts: [
        {
          checksum: "1234",
          id: "some identifier for the artifact1",
          names: ["name of related artifact", "another name"],
        },
      ],
      sourceUri: "the git repo url/tree/git commit hash",
      logsUri: "location of build logs",
      originals: [
        {
          name:
            "projects/rode/occurrences/8865bc74-7ac0-4c2f-bcb2-d4ed1382ca5c",
          resource: {
            name: "",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
  ...
  secure: [
    {
      ...
      vulnerabilities: [
        {
          name:
            "projects/rode/occurrences/82804d42-9e51-48c1-b4e8-da2249cf3d90",
          type: "docker",
          cvssScore: 0,
          ...
          relatedUrls: [
            ...
            { url: "https://ubuntu.com/security/CVE-2011-3374", label: "" },
          ],
          cpeUri: "https://nvd.nist.gov/vuln/detail/CVE-2011-3374",
          packageName: "apt",
          version: { epoch: 0, name: "apt", revision: "", kind: "NORMAL" },
        },
        {
          name:
            "projects/rode/occurrences/cd2ba444-9761-4213-9e83-72eedfb35513",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
          effectiveSeverity: "LOW",
          ...
          relatedUrls: [
            ...
            { url: "https://www.youtube.com/watch?v=-wGtxJ8opa8", label: "" },
          ],
          cpeUri: "https://nvd.nist.gov/vuln/detail/CVE-2019-18276",
          packageName: "bash",
          version: { epoch: 0, name: "bash", revision: "", kind: "NORMAL" },
        },
        {
          name:
            "projects/rode/occurrences/d6d98c39-15bd-4dca-8a25-0b01ed3c2eb0",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
          effectiveSeverity: "LOW",
        ...
        {
          name:
            "projects/rode/occurrences/d1d5cbc1-f7e0-4427-862d-29a60994bb69",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
          effectiveSeverity: "LOW",
        ...
        {
          name:
            "projects/rode/occurrences/d534a727-0d2a-4792-b1ab-f9b7c3cf60fe",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
          effectiveSeverity: "LOW",
        ...
        {
          name:
            "projects/rode/occurrences/86503ffc-4f8d-4dce-8ed9-1294a48d27f8",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
          ...
          relatedUrls: [
            ...
            { url: "https://usn.ubuntu.com/usn/usn-4402-1", label: "" },
          ],
          cpeUri: "https://nvd.nist.gov/vuln/detail/CVE-2020-8169",
          packageName: "curl",
          version: { epoch: 0, name: "curl", revision: "", kind: "NORMAL" },
        },
        {
          name:
            "projects/rode/occurrences/14dbe712-1aca-48b6-87f1-e972aa549089",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
        ...
        {
          name:
            "projects/rode/occurrences/180c3a5b-6914-4de6-a0df-1f2a3c2681dc",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
        ...
        {
          name:
            "projects/rode/occurrences/2c2b5b7a-21f7-4d2c-b6b4-ce4cd93eccc4",
          type: "docker",
          cvssScore: 0,
          severity: "SEVERITY_UNSPECIFIED",
      ...
      originals: [
        {
          name:
            "projects/rode/occurrences/c5ff7eac-1447-44e0-8729-3aeb0a00c3cb",
          resource: {
            name: "",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
        ...
        {
          name:
            "projects/rode/occurrences/e233fa36-7a68-4822-b1b3-eb56358eb2e9",
          resource: {
            name: "",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
            ...
            packageIssue: [
              {
                affectedLocation: {
                  cpeUri:
                    "https://nvd.nist.gov/vuln/detail/TEMP-0841856-B18BAF",
                  package: "bash",
                  version: {
                    epoch: 0,
                    name: "bash",
    ...
    },
    {
      ...
      started: "2020-02-09T16:24:11Z",
      completed: "2020-02-09T16:24:18Z",
      vulnerabilities: [],
      originals: [
        {
          name:
            "projects/rode/occurrences/61896764-8967-4c11-86fc-941cefbcf5ae",
          resource: {
            name: "",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
        ...
        {
          name:
            "projects/rode/occurrences/b377cd00-5a64-40e4-a7a7-f33d4fe848b1",
          resource: {
            name: "",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
  ...
  deploy: [
    {
      ...
      originals: [
        {
          name:
            "projects/rode/occurrences/05f0f2a8-93fd-470d-8202-ec3fd542e8a9",
          resource: {
            name: "some name",
            uri:
              "harbor.localhost/library/nginx@sha256:0b159cd1ee1203dad901967ac55eee18c24da84ba3be384690304be93538bea8",
